...
@section('title', 'New order estimation')
@section('header', 'New order estimation')
...
<div class="col-xs-10">
  ...
  <br>
  <input type="checkbox" name="eps" value="">Eps delivery only
  <br>
...
<p>Estimated date delivery: 2018/00/00</p>
    <center>
        <button class="btn "style="background-color:#003b99; color:white; width:200px; border-radius:30px; margin-left:25px;" type="button" name="estim_req">Estimation Request</button>
      </center>
